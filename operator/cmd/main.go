...
import (
	...
	"github.com/trasa/EliteEvents/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(elitev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err := (&controller.FeedListenerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "feedlistener")
		os.Exit(1)
	}
